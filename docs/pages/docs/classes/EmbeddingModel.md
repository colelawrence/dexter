...
[src/model/embedding.ts:48](https://github.com/colelawrence/dexter/blob/6b94c49/src/model/embedding.ts#L48)

## Properties

| Property | Type | Description | Inheritance | Source |
| :------ | :------ | :------ | :------ | :------ |
| `modelProvider` | `"openai"` | - | [`AbstractModel`](AbstractModel.md).`modelProvider` | [src/model/embedding.ts:44](https://github.com/colelawrence/dexter/blob/6b94c49/src/model/embedding.ts#L44) |
| `modelType` | `"embedding"` | - | [`AbstractModel`](AbstractModel.md).`modelType` | [src/model/embedding.ts:43](https://github.com/colelawrence/dexter/blob/6b94c49/src/model/embedding.ts#L43) |
| `throttledModel` | `BulkEmbedder` | - | - | [src/model/embedding.ts:45](https://github.com/colelawrence/dexter/blob/6b94c49/src/model/embedding.ts#L45) |
...
[src/model/embedding.ts:157](https://github.com/colelawrence/dexter/blob/6b94c49/src/model/embedding.ts#L157)
